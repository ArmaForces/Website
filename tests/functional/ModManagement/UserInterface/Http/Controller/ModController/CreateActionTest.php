...
namespace App\Tests\Functional\ModManagement\UserInterface\Http\Controller\ModController;
...
/**
 * @internal
 * @covers \App\ModManagement\UserInterface\Http\Controller\ModController
 */
final class CreateActionTest extends WebTestCase
{
    ...
    {
        $this->client->request(Request::METHOD_GET, RouteEnum::MOD_CREATE);
