...
namespace App\Tests\Functional\ModManagement\UserInterface\Http\Controller\ModGroupController;
...
/**
 * @internal
 * @covers \App\ModManagement\UserInterface\Http\Controller\ModGroupController
 */
final class CreateActionTest extends WebTestCase
{
    ...
    {
        $this->client->request(Request::METHOD_GET, RouteEnum::MOD_GROUP_CREATE);
