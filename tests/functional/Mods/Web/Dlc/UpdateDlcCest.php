...
class UpdateDlcCest
{
    ...
    public function updateDlcAsAuthorizedUser(FunctionalTester $I): void
    {
        ...
        // Default form values
        $I->seeInField('Steam Store URL', 'https://store.steampowered.com/app/1227700');
        $I->seeInField('DLC directory', 'vn');
        $I->seeInField('DLC name', 'Arma 3 Creator DLC: S.O.G. Prairie Fire');
        ...
        $I->assertSame(null, $dlc->getCreatedBy()?->getId()->toString());
        $I->assertSame('2021-01-01T00:00:00+00:00', $dlc->getLastUpdatedAt()?->format(DATE_ATOM));
        $I->assertSame($currentUser->getId()->toString(), $dlc->getLastUpdatedBy()?->getId()->toString());
    }

    public function updateDlcAsAuthorizedUserWithNameProvidedBySteamWorkshop(FunctionalTester $I): void
    {
        $currentUser = $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWhenDlcAlreadyExists(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });

        $I->amOnPage(sprintf('/dlc/%s/update', CslaIronCurtainDlcFixture::ID));
    ...
    public function updateDlcAsAuthorizedUserWithInvalidDlcUrl(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWhenDlcDoesNotExistInSteamApi(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWhenUrlIsNotAnArma3Dlc(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWithInvalidDirectoryName(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWithoutRequiredData(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWithDataTooLong(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });
    ...
    public function updateDlcAsAuthorizedUserWhenDlcDoesNotExist(FunctionalTester $I): void
    {
        $I->amDiscordAuthenticatedAs(User1Fixture::ID, function (User $user): void {
            $user->getPermissions()->dlcUpdate = true;
        });

        $I->amOnPage(sprintf('/dlc/%s/update', 'd2cca3c6-1c5f-4ea7-afcf-a05317a58467'));
