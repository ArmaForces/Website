...
class GetModListsByIdCest
{
    ...
    public function getModListByIdUsingInvalidApiKey(FunctionalTester $I): void
    {
    ...
    public function getModListByIdUsingValidApiKey(FunctionalTester $I): void
    {
    ...
    public function getModListByIdUsingValidApiKeyWhenModListDoesNotExist(FunctionalTester $I): void
    {
        $I->amApiKeyAuthenticatedAs('test_key');

        $I->sendGet(sprintf('/api/mod-lists/%s', 'd2cca3c6-1c5f-4ea7-afcf-a05317a58467'));
