...
class DeleteStandardModListVoter extends Voter
{
    protected function supports(string $attribute, $subject): bool
    {
        return PermissionsEnum::STANDARD_MOD_LIST_DELETE->value === $attribute && $subject instanceof StandardModList;
    }
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        return $subject->getOwner() === $currentUser
            || $currentUser->hasPermissions(static fn (AbstractPermissions $permissions) => $permissions->standardModListDelete);
    }
}
