...
class ApproveModListVoter extends Voter
{
    ...
    {
        return PermissionsEnum::MOD_LIST_APPROVE->value === $attribute;
    }
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        return $currentUser->hasPermissions(static fn (AbstractPermissions $permissions) => $permissions->modListApprove);
    }
}
